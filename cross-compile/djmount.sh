...
DIRP="$(pwd)"
get 'http://sourceforge.net/projects/pupnp/files/pupnp/libUPnP 1.6.6/libupnp-1.6.6.tar.bz2'
DIRU="$(pwd)"
get_dj() { mv libupnp libupn_org; ln -s "../${DIRU##*/}" libupnp; patch -p1 -i "$DIRP/djmount.patch"; }
get 'http://sourceforge.net/projects/djmount/files/djmount/0.71/djmount-0.71.tar.gz' run=get_dj
