...
cd ../..
if [ "$PLATFORM" = S7 ]; then CC_DIR="$(pwd)/Saturn7/cross-compiler"; CC_PREF=mipsel-linux; CC_DFB="$(pwd)/Saturn7/GP2_MSTAR/directFB"; #PKG_CFG="$CC_DIR/mipsel-lg-linux-gnu/sys-root/lib:$CC_DIR/mipsel-lg-linux-gnu/sys-root/usr/lib"
else CC_DIR="$(pwd)/cross-compiler-mipsel"; CC_PREF=mipsel; CC_DFB="$(pwd)/Saturn6/GP1_MSTAR/directFB"; fi
