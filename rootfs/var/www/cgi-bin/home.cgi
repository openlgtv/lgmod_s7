...
<? cat /var/www/cgi-bin/header.inc ?><p class="largefont">LGMOD CONFIGURATION / HOME</p><div class="pagebody">
...
<b>OPENRELEASE</b> by rtokarev: telnet to RELEASE (on port 2323 - tmux is not needed now),<br>
remap remote control buttons, "server" mode (soft_poweroff) and more...<br><br>
