...
<div class="post"><div class="posthead">Ethernet Configuration</div><div class="posttext">
<b>Use DHCP:</b><?
...
<div class="post"><div class="posthead">Network Services Configuration</div><div class="posttext">
<?
echo '<b>UPnP Client (enable your TV as UPnP ControlPoint/Renderer:</b>'
...
if [ -e /mnt/lg/user/lgmod/telnet ]; then
  echo '<input name="tel" type="checkbox" value="1" checked><br>'
else
  echo '<input name="tel" type="checkbox" value="1"><br>'
fi

echo '<br><b>Launch ftpd service at startup:</b>'
if [ -e /mnt/lg/user/lgmod/ftp ]; then
  ...
  echo "FTP mount point (default /):<input name='pFtp' type='text' id='pFtp' value='$pFtp'><br><br>"
else
  echo '<input name="ftp" type="checkbox" value="1" onclick="pFtp.disabled=!ftp.checked">' && pFtp=""
  echo "FTP mount point (default /):<input name='pFtp' type='text' id='pFtp' disabled value='$pFtp'><br><br>"
fi
...
?></div></div>
<center><input type="submit" name="save" value="Save config"></center></form>
